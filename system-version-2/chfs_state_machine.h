...
public:
    ...
    virtual std::pair<std::vector<char*>,std::vector<int>> snapshot1(vector<char*> &v,std::vector<int> &v1);
    ...
    virtual void apply_snapshot1(vector<char*> &v,std::vector<int> &v1);
...
private:
    ...
    std::map<uint32_t , bool> cmd_executed;
};
